...
Menu::Menu(SDL_Event* e, SDL_Window* gWindow, SDL_Renderer* gRenderer, const char* Path, int width, int height) {
    ...
    // Initialize buttons
    this->Buttons[0] = new Button(gRenderer, gWindow, "Data\\Buttons\\Mainmenu\\start0.png", { 500, 400 }, { 422, 110 }); // 250
    this->Buttons[1] = new Button(gRenderer, gWindow, "Data\\Buttons\\Mainmenu\\load0.png", { 500, 510 }, { 422, 110 }); // 360
    this->Buttons[2] = new Button(gRenderer, gWindow, "Data\\Buttons\\Mainmenu\\quit0.png", { 500, 620 }, { 422, 110 }); // 470
