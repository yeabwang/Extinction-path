...
Bomb::Bomb(SDL_Window* gWindow, SDL_Renderer* grenderer, int posX, int posY, float moveX, float moveY, const char* description)
{
...
{
    if (strcmp(CollidedWith->getType(), "HERO") == 0)
    {
